...
//     const copyrekwanita = () => {
//         navigator.clipboard.writeText('901661474611');
//         Swal.fire({
//             html: "Berhasil menyalin <br> rekening: <b>901661474611</b>",
//             icon: 'success',
...
//                             <p className='text-center font-medium text-white custom-font-3 md:text-xl'>Bagi yang ingin memberikan amplop sebagai hadiah untuk Ngunduh Mantu kami, silakan transfer ke rekening ya 😊</p>
...
//                                 <div>
//                                     <div className='bg-[#dfc4a7] rounded-lg py-3 mb-2'>
//                                         <h1 className='text-center font-medium text-[#413327] text-2xl'>BCA <br /> 1650595021 <br /> Leo Dwi Kurniawan</h1>
//                                     </div>
...
export default function ModalAmplop({ onClose, visible }) {
    ...
    const wawanita = () => {
        window.open('https://api.whatsapp.com/send?phone=6285606021464', "_blank");
    }
            ...
            >
                <Modal.Body className='bg-[#413327] rounded-lg border-0 shadow-lg'>
                    ...
                    <div className="space-y-6">
                        <div className='text-5xl custom-font-2 text-center text-white'>Berikan Amplop</div>
                        <p className='text-center font-medium text-white custom-font-3 md:text-xl'>
                            Bagi yang ingin memberikan amplop sebagai hadiah untuk Ngunduh Mantu kami, silakan transfer ke rekening ya 😊
                        </p>

                        <div className='grid grid-cols-1 gap-4 mb-4'>
                            <div>
                                <div className='bg-[#dfc4a7] rounded-lg py-3 mb-2'>
                                    <h1 className='text-center font-medium text-[#413327] text-2xl'>
                                        Seabank <br /> 901661474611 <br /> Nur Roisyatul Afifah
                                    </h1>
                                </div>
                                <button onClick={copyrekwanita} className='py-3 bg-gray-500 rounded-lg w-full mb-2 text-white hover:bg-gray-700'>
                                    <FontAwesomeIcon icon={faCopy} className="mr-2" />
